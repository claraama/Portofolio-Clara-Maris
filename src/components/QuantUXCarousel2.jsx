...
import firstImageInteractiveMenu from "../assets/QuantUX2.png";
import secondImageInteractiveMenu from "../assets/QuantUX3.png";


export default function QuantUXCarousel2() {
    const images = [
