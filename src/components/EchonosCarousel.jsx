...
import firstImageInteractiveMenu from "../assets/echnos1.png";
import secondImageInteractiveMenu from "../assets/echonos2.png";
import thirdImageInteractiveMenu from "../assets/echonos3.png";

export default function EchonosCarousel() {
    const images = [
        firstImageInteractiveMenu,
        secondImageInteractiveMenu,
        thirdImageInteractiveMenu
      ];
