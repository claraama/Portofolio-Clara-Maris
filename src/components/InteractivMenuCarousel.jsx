...
import firstImageInteractiveMenu from "../assets/lowPrototypeInteractive.png";
import secondImageInteractiveMenu from "../assets/highPrototypeInteractive.png";

export default function InteractiveMenuCarousel() {
    const images = [
      ...
      return (
        <div className="relative w-[50%] max-w-[400px] mx-auto mt-20">
